package com.example.volunteersmanagement.Adapters
...
class VolAdapter(private val volList: ArrayList<VolunteersModel>) : RecyclerView.Adapter<VolAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.view.text = currentVol.fName
...
private fun Nothing?.onItemClick(adapterPosition: Int) {
